...
一个基于原生 HTML / CSS / JavaScript 的静态企业官网，采用 **DeepSeek 光网风格**：浅色底、蓝紫渐变（`#4D6BFE → #7C5CFC`）、柔和光晕与光网网格背景、圆角卡片、现代排版。
...
| `products.html` | 产品介绍（12 个道地药材，支持分类筛选） |
| `industry.html` | 行业动态 |
| `news.html` | 新闻中心 |
...
1. 在 GitHub 新建一个**公开**仓库（建议名：`baicaoyuan`），不要勾选 README。
