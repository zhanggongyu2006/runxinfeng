# 新疆润欣丰 · 网站设计规范（DESIGN.md）

> 本规范为该项目的**唯一设计权威**，所有页面/组件改动必须严格遵循。
> 来源：awesome-design-md 仓库（本地副本 E:\中药材相关本地\awesome-design-md），
> 依据本项目「药材草本 · 高端零售」定位选定 Starbucks 设计体系。
> 常用速查：暖米白画布 #f2f0eb · 墨绿阶 #006241/#00754A/#1E3932 · 金 #cba258 · 正文 rgba(0,0,0,.87) · 按钮 50px 全胶囊 · 卡片 12px 圆角 · 轻叠影 · 无渐变填充。
